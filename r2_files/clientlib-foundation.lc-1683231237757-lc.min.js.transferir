                    ...
                    if (null != i) {
                      ...
                      if ("string" == typeof i) {
                        ...
                        if (
                          ...
                          y = x[0];
                          for (var I = x.length, O = 1; O < I; O += 1)
                            y += x[O];
        ...
        function (e, t, r) {
          ...
          e.exports = function (e, t, r, n) {
            ...
            if (-1 !== y) {
              ...
              if (
                ((g = Math.min(x, g)), -1 !== (y = e.lastIndexOf(t, v + m)))
              ) {
                var b = E(t, {
                  errors: 0,
                  currentLocation: y,
     ...
     */ !(function (t, n) {
      ...
      var C =
        ...
        (function (e) {
          ...
          try {
            N.apply((j = H.call(x.childNodes)), x.childNodes),
          ...
          function (e, t) {
            k.fn[e] = function (n, i) {
              ...
              return (
                ...
                this.length > 1 &&
                  (P[e] || k.uniqueSort(o), H.test(e) && o.reverse()),
                this.pushStack(o)
              );
            };
          }
        ...
        special: {
          ...
          click: {
            ...
            trigger: function (e) {
              var t = this || e;
              return (
                ve.test(t.type) && t.click && L(t, "input") && je(t, "click"),
                !0
              );
            },
            _default: function (e) {
      ...
      function Me(e, t) {
        ...
        if (1 === t.nodeType) {
          ...
          K.hasData(e) &&
            ((r = K.access(e)), (s = k.extend({}, r)), K.set(t, s));
        }
      }
      function Ie(e, t) {
        var n = t.nodeName.toLowerCase();
      ...
      function Re(e, t, n, i) {
        ...
        var o,
          ...
          h = t[0],
          v = y(h);
        if (v || (p > 1 && "string" == typeof h && !g.checkClone && Oe.test(h)))
          return e.each(function (o) {
            var r = e.eq(o);
            v && (t[0] = h.call(this, o, r.html())), Re(r, t, n, i);
          });
        if (
          p &&
          ...
          for (a = (s = k.map(we(o, "script"), Pe)).length; u < p; u++)
            (c = o),
              u !== f &&
                ((c = k.clone(c, !0, !0)), a && k.merge(s, we(c, "script"))),
              n.call(e[u], c, u);
          if (a)
            for (
      ...
      k.extend(k.event, {
        trigger: function (e, t, i, o) {
          ...
          if (
            ...
            if (!o && !u.noBubble && !m(i)) {
              for (
                l = u.delegateType || v, Tt.test(l + v) || (s = s.parentNode);
                s;
                s = s.parentNode
              )
                h.push(s), (a = s);
          ...
          ajax: function (e, t) {
            ...
            function C(e, t, s, l) {
              ...
              c ||
                ...
                (S.status = e),
                (S.statusText = (t || T) + ""),
                u ? g.resolveWith(h, [p, T, S]) : g.rejectWith(h, [S, T, w]),
                S.statusCode(m),
                (m = void 0),
                d &&
      ...
      return (
        (k.noConflict = function (e) {
          return (
            n.$ === k && (n.$ = Kt), e && n.jQuery === k && (n.jQuery = Jt), k
          );
        }),
...
// --------------------- patch start
  function (e, t, n) {
    ...
    class r {
      constructor() {
        (this.searchResultsForm = o()("form[data-searchresults-form]")),
          this.searchResultsForm.length > 0 &&
            ((this.searchResultsUl = o()("ul[data-searchresults-ul]")),
            (this.searchResultsViewMore = this.createViewMore()),
            (this.resultsOffsetInput = o()("input[name='resultsOffset']")),
            (this.noResultsText = o()(
              "div[data-searchresults-noresultstext]"
            ).data("searchresults-noresultstext")),
            (this.linkText = o()("div[data-searchresults-linktext]").data(
              "searchresults-linktext"
            )),
            (this.resultsOffsetValue = parseInt(this.resultsOffsetInput.val())),
            this.searchResultsUl.html(""),
            this.searchResultsForm.submit(this.onFormSubmit()));
        this.fuse = null;

        this.loadSearchData().then(() => {
          o()(document).ready(() => {
            this.searchResultsForm.trigger("submit");
          });
        });
      }

loadSearchData() {
    const searchDataURL = this.searchResultsForm.attr("action");
    ...
    return new Promise((resolve) => {
      fetch(searchDataURL)
        ...
        .then((data) => {
          ...
          // Resolve the promise once Fuse is initialized
          resolve();
        });
    });
  }
      ...
      onFormSubmit() {
        return (e) => {
          ...
          const searchTerm = urlParams.get("fulltext");
          console.log("searchTerm", searchTerm);
          o()("#searchterm").html(searchTerm);
      ...
      updateOffset() {
        this.resultsOffsetValue += this.resultsSize;
        this.resultsOffsetInput.val(this.resultsOffsetValue);
      }

      renderResults(results) {
        if (results.length > 0) {
          results.forEach((result) => {
            this.searchResultsUl.append(`<li>
              <p>${result.item.title}</p>
              <span>${result.item.description}</span>
              <a href="${result.item.url}">${this.linkText}</a>
            </li>`);
          });

          if (this.resultsSize === results.length) {
            this.searchResultsViewMore.insertAfter(this.searchResultsUl);
          }
        } else {
          this.searchResultsUl.append(`<p>${this.noResultsText}</p>`);
        }
      }

      createViewMore() {
        const viewMoreText = o()(
          "div[data-searchresults-viewmoreresultstext]"
        ).data("searchresults-viewmoreresultstext");
        const viewMoreLink = o()("<a class='search-result-cta'></a>").text(
          viewMoreText
        );
    ...
    class s {
      constructor() {
        const e = o()(".productcarousel .cmp-list");
        (this.settings = {
          $carousel: e,
          $slidesToShow: e.data("slides-to-show") || 1,
          $slidesToScroll: e.data("slides-to-scroll") || 1,
          $carouselItem: o()(".cmp-list__item"),
          carouselItemLink: ".cmp-list__item-cta a",
          carouselItemImage: ".cmp-list__item-img",
        }),
          this.initSlider(this.settings),
          this.onResize(this.settings),
          this.addLinkToImg(this.settings);
      }
      initSlider({ $carousel: e, $slidesToShow: t, $slidesToScroll: n }) {
        e.slick({
          slidesToShow: t,
          slidesToScroll: n,
          arrows: !0,
      ...
      onResize({ $carousel: e, $slidesToShow: t, $slidesToScroll: n }) {
        let i;
        o()(window).on("resize", () => {
          clearTimeout(i),
            (i = setTimeout(() => {
        ...
        e.each((e, r) => {
          o()(r)
            ...
            .each((e, t) => {
              const r = o()(t).find(i),
                s = o()(t).find(n);
              r.clone().appendTo(s.parent()).text(""),
                s.siblings("a").wrapInner(s);
            });
        });
      }
    }
    class a {
      constructor() {
        (this.elements = {
          dataLayerElement: document.querySelector(".dataLayer-data"),
        }),
          this.pushDataObject();
      }
      pushDataObject() {
        this.elements.dataLayerElement &&
          ((window.dataLayer = window.dataLayer || []),
          window.dataLayer.push({
            property: {
              name: this.elements.dataLayerElement.dataset.name,
              powerBrands: this.elements.dataLayerElement.dataset.powerbrands,
              brands: this.elements.dataLayerElement.dataset.brands,
              regions: this.elements.dataLayerElement.dataset.regions,
              markets: this.elements.dataLayerElement.dataset.markets,
              platform: this.elements.dataLayerElement.dataset.platform,
              devEnvironment:
                this.elements.dataLayerElement.dataset.devenvironment,
              domain: this.elements.dataLayerElement.dataset.domain,
              cmsVersion: this.elements.dataLayerElement.dataset.cmsversion,
              dataPrivacyRegulation:
                this.elements.dataLayerElement.dataset.dataprivacyregulation,
              cookiePolicyVersion:
                this.elements.dataLayerElement.dataset.cookiepolicyversion,
              privacyPolicyVersion:
                this.elements.dataLayerElement.dataset.privacypolicyversion,
              termsAndConditionsVersion:
                this.elements.dataLayerElement.dataset
                  .termsandconditionsversion,
            },
            page: {
              type: this.elements.dataLayerElement.dataset.pagetemplatetype,
              language: this.elements.dataLayerElement.dataset.pagelanguage,
              targetAudience:
                this.elements.dataLayerElement.dataset.pagetargetaudience,
              targetNeedState:
                this.elements.dataLayerElement.dataset.pagetargetneedstate,
              targetPassionPoints:
                this.elements.dataLayerElement.dataset.pagetargetpassionpoints,
              tags: this.elements.dataLayerElement.dataset.pagetags,
            },
          }));
      }
    }
